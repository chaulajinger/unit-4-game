$(document).ready(function() {
	...
	var gemOne = Math.floor(Math.random() * 12) + 1; 
		...
		$("#img1").html("<img src=" + "assets/images/Diamond_Blue.png" + " value=" + gemOne + ">"); 

	var gemTwo = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 2: " + gemTwo); 
		$("#img2").html("<img src=" + "assets/images/Diamond_Green.png" + " value=" + gemTwo + ">"); 

	var gemThree = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 3: " + gemThree); 
		$("#img3").html("<img src=" + "assets/images/Diamond_Red.png" + " value=" + gemThree + ">");
	
	var gemFour = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 4: " + gemFour); 
		$("#img4").html("<img src=" + "assets/images/Diamond_Yellow.png" + " value=" + gemFour + ">");
